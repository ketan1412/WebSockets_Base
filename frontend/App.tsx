...
const App: React.FC = () => {
  ...
  console.log('App render - matches:', matches.length, 'activeMatchId:', activeMatchId, 'status:', status);

  const totalPages = useMemo(() => Math.max(1, Math.ceil(matches.length / pageSize)), [matches.length, pageSize]);
